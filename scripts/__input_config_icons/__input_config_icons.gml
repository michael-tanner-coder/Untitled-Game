...
.add("arrow up", spr_keyboard_arrow_up)
.add("arrow down", spr_keyboard_arrow_down)
.add("arrow left", spr_keyboard_arrow_left)
.add("arrow right", spr_keyboard_arrow_right)
